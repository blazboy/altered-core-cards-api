...
#[ORM\Index(name: "idx_ability_effect_altered_id", fields: ["alteredId"])]
#[ORM\Entity(repositoryClass: AbilityEffectRepository::class)]
#[ApiResource(
    operations: [
        new Get(),
        new GetCollection(),
    ],
    normalizationContext: ['groups' => ['ability_effect:read']],
    paginationItemsPerPage: 20,
)]
#[ApiFilter(SearchFilter::class, properties: ['textFr' => 'partial', 'textEn' => 'partial'])]
class AbilityEffect
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
